var AdNetworkAPI = (function (exports) {
	...
	const fromHexString = (hexString) => { var _a; return new Uint8Array(((_a = hexString.match(/.{1,2}/g)) !== null && _a !== undefined ? _a : []).map(byte => parseInt(byte, 16))); };
	...
	function requireSerializer () {
		...
		var __importStar = (serializer$1.__importStar) || function (mod) {
	...
	class ExpirableMap {
	    ...
	    constructor(options = {}) {
	        // Internals
	        _ExpirableMap_inner.set(this, undefined);
	        _ExpirableMap_expirationTime.set(this, undefined);
	...
	class Ed25519PublicKey {
	    ...
	    constructor(key) {
	        _Ed25519PublicKey_rawKey.set(this, undefined);
	        _Ed25519PublicKey_derKey.set(this, undefined);
	...
	class ExponentialBackoff {
	    constructor(options = ExponentialBackoff.default) {
	        _ExponentialBackoff_currentInterval.set(this, undefined);
	        _ExponentialBackoff_randomizationFactor.set(this, undefined);
	        _ExponentialBackoff_multiplier.set(this, undefined);
	        _ExponentialBackoff_maxInterval.set(this, undefined);
	        _ExponentialBackoff_startTime.set(this, undefined);
	        _ExponentialBackoff_maxElapsedTime.set(this, undefined);
	        _ExponentialBackoff_maxIterations.set(this, undefined);
	...
	function determineHost(configuredHost) {
	    ...
	    if (configuredHost !== undefined) {
	        ...
	        const hostname = location === null || location === undefined ? undefined : location.hostname;
	        let knownHost;
	...
	class HttpAgent {
	    ...
	    constructor(options = {}) {
	        ...
	        _HttpAgent_identity.set(this, undefined);
	        _HttpAgent_fetch.set(this, undefined);
	        _HttpAgent_fetchOptions.set(this, undefined);
	        _HttpAgent_callOptions.set(this, undefined);
	        _HttpAgent_timeDiffMsecs.set(this, 0);
	        _HttpAgent_credentials.set(this, undefined);
	        _HttpAgent_rootKeyFetched.set(this, false);
	        _HttpAgent_retryTimes.set(this, undefined); // Retry requests N times before erroring by default
	        _HttpAgent_backoffStrategy.set(this, undefined);
	        _HttpAgent_maxIngressExpiryInMinutes.set(this, undefined);
	        ...
	        _HttpAgent_verifyQueryResponse.set(this, (queryResponse, subnetStatus) => {
	            ...
	            for (const sig of signatures) {
	                ...
	                const pubKey = subnetStatus === null || subnetStatus === undefined ? undefined : subnetStatus.nodeKeys.get(nodeId);
	                if (!pubKey) {
	                    throw new CertificateVerificationError('Invalid signature from replica signed query: no matching node key found.');
	                }
	    ...
	    async query(canisterId, fields, identity) {
	        ...
	        const makeQuery = async () => {
	            ...
	            const canister = Principal$1.from(canisterId);
	            const sender = (id === null || id === undefined ? undefined : id.getPrincipal()) || Principal$1.anonymous();
	            const request = {
	    ...
	    request) {
	        ...
	        const transformedRequest = request !== null && request !== undefined ? request : (await this.createReadStateRequest(fields, identity));
	...
	async function pollForResponse(agent, canisterId, requestId, strategy = defaultStrategy(), request, blsVerify) {
	    ...
	    const currentRequest = request !== null && request !== undefined ? request : (await ((_a = agent.createReadStateRequest) === null || _a === undefined ? undefined : _a.call(agent, { paths: [path] })));
	        ...
	        class CanisterActor extends Actor {
	            constructor(config) {
	                ...
	                for (const [methodName, func] of service._fields) {
	                    ...
	                    if (options === null || options === undefined ? undefined : options.certificate) {
	...
	const idlFactory = ({ IDL }) => {
	    ...
	    return IDL.Service({
	      ...
	      'getNextAd' : IDL.Func([IDL.Text, IDL.Text], [IDL.Opt(Ad)], []),
	...
	/* ===========================================
	   ANONYMOUS (NO AUTH) FOR AD NETWORK
	   =========================================== */
	async function createActorAnonymous() {
	...
	async function getNextAd(projectId, adType) {
	  checkActor();
	  return await adNetworkActor.getNextAd(projectId, adType);
	}
	...
	function checkActor() {
	  if (!adNetworkActor) {
	    throw new Error("AdNetwork actor is not initialized. Call initActorUnauthenticated() first.");
	  }
	}
